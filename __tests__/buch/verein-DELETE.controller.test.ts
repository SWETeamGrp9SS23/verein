...
describe('DELETE /rest/vereine', () => {
    ...
    test('Vorhandener Verein loeschen', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Verein loeschen, aber ohne Token', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Verein loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/rest/${id}`;
        const token = 'FALSCH';
        const headers: Record<string, string> = {
